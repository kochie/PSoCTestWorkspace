...
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x48000BA0u)
...
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x48000BB0u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DSM0_SW0, 0x70u);
