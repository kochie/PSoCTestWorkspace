// ======================================================================
// ArmEncoderTest.v generated from TopDesign.cysch
// 09/28/2016 at 13:36
...
// QuadDec_v3_0(Counter8bit=false, CounterResolution=1, CounterSize=16, CounterSizeReplacementString=int16, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ClawQuadDec, CY_INSTANCE_SHORT_NAME=ClawQuadDec, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=ClawQuadDec, )
...
module top ;
    ...
    QuadDec_v3_0_1 ClawQuadDec (
        .quad_A(Net_1),
        .quad_B(Net_2),
        .index(1'b0),
        .clock(Net_7),
        .interrupt(Net_8));
    defparam ClawQuadDec.CounterResolution = 1;
    defparam ClawQuadDec.UsingGlitchFiltering = 1;
    defparam ClawQuadDec.UsingIndexInput = 0;

	wire [0:0] tmpOE__PhaseA_net;
	wire [0:0] tmpIO_0__PhaseA_net;
	wire [0:0] tmpINTERRUPT_0__PhaseA_net;
	electrical [0:0] tmpSIOVREF__PhaseA_net;
	...
	cy_psoc3_pins_v1_10
		...
		PhaseA
		 (.oe(tmpOE__PhaseA_net),
		  .y({1'b0}),
		  .fb({Net_1}),
		  .io({tmpIO_0__PhaseA_net[0:0]}),
		  .siovref(tmpSIOVREF__PhaseA_net),
		  .interrupt({tmpINTERRUPT_0__PhaseA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PhaseA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PhaseB_net;
	wire [0:0] tmpIO_0__PhaseB_net;
	wire [0:0] tmpINTERRUPT_0__PhaseB_net;
	electrical [0:0] tmpSIOVREF__PhaseB_net;

	cy_psoc3_pins_v1_10
		#(.id("66510fc7-90ce-47dd-8257-beb85695d914"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PhaseB
		 (.oe(tmpOE__PhaseB_net),
		  .y({1'b0}),
		  .fb({Net_2}),
		  .io({tmpIO_0__PhaseB_net[0:0]}),
		  .siovref(tmpSIOVREF__PhaseB_net),
		  .interrupt({tmpINTERRUPT_0__PhaseB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PhaseB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("60899ca0-2dd5-4e5c-9f07-1a23bfebbf9a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
