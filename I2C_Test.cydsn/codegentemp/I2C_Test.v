...
module I2C_v3_50_0 (
	...
	cy_clock_v1_0
		#(.id("0bce47f4-5c59-4867-bf0c-4c6ef6691b75/5ece924d-20ba-480e-9102-bc082dcdd926"),
...
module I2C_v3_50_1 (
	...
	cy_clock_v1_0
		#(.id("3508f121-fc03-4d58-8f7e-0706f5616a28/5ece924d-20ba-480e-9102-bc082dcdd926"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
...
module top ;
	...
	wire [0:0] tmpOE__sda_master_net;
	wire [0:0] tmpFB_0__sda_master_net;
	wire [0:0] tmpINTERRUPT_0__sda_master_net;
	electrical [0:0] tmpSIOVREF__sda_master_net;
	...
	cy_psoc3_pins_v1_10
		...
		sda_master
		 (.oe(tmpOE__sda_master_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__sda_master_net[0:0]}),
		  .io({Net_34}),
		  .siovref(tmpSIOVREF__sda_master_net),
		  .interrupt({tmpINTERRUPT_0__sda_master_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__sda_master_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__scl_master_net;
	wire [0:0] tmpFB_0__scl_master_net;
	wire [0:0] tmpINTERRUPT_0__scl_master_net;
	electrical [0:0] tmpSIOVREF__scl_master_net;

	cy_psoc3_pins_v1_10
		#(.id("9b78ad36-5ae2-445e-b208-84478a6851c7"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		scl_master
		 (.oe(tmpOE__scl_master_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__scl_master_net[0:0]}),
		  .io({Net_35}),
		  .siovref(tmpSIOVREF__scl_master_net),
		  .interrupt({tmpINTERRUPT_0__scl_master_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__scl_master_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__sda_slave_net;
	wire [0:0] tmpFB_0__sda_slave_net;
	wire [0:0] tmpINTERRUPT_0__sda_slave_net;
	electrical [0:0] tmpSIOVREF__sda_slave_net;

	cy_psoc3_pins_v1_10
		#(.id("40a350d2-635d-43ea-b96b-0569634ac8a8"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		sda_slave
		 (.oe(tmpOE__sda_slave_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__sda_slave_net[0:0]}),
		  .io({Net_45}),
		  .siovref(tmpSIOVREF__sda_slave_net),
		  .interrupt({tmpINTERRUPT_0__sda_slave_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__sda_slave_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__scl_slave_net;
	wire [0:0] tmpFB_0__scl_slave_net;
	wire [0:0] tmpINTERRUPT_0__scl_slave_net;
	electrical [0:0] tmpSIOVREF__scl_slave_net;

	cy_psoc3_pins_v1_10
		#(.id("c8a83c64-a959-4e0f-bb32-40ec2d7d0ec6"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		scl_slave
		 (.oe(tmpOE__scl_slave_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__scl_slave_net[0:0]}),
		  .io({Net_46}),
		  .siovref(tmpSIOVREF__scl_slave_net),
		  .interrupt({tmpINTERRUPT_0__scl_slave_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__scl_slave_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    UART_v2_50_2 UART_USB (
        .cts_n(1'b0),
        .tx(Net_58),
        .rts_n(Net_71),
        .tx_en(Net_72),
